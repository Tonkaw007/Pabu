...
import CarparkingScreen from "./src/screens/CarparkingScreen";  // Make sure this is correctly imported
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home"> 
        ...
        />
        <Stack.Screen 
          name="Carparking"   // Updated name here to match the navigation
